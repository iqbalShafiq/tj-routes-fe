  ...
  return (
    <div className="max-w-md mx-auto animate-fade-in">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600">Join TransJakarta Routes to report issues and track changes</p>
      </div>
      <Card static>
        <form
          onSubmit={async (e) => {
        ...
        <p className="mt-8 text-center text-sm text-slate-600">
          ...
          <a href="/auth/login" className="text-amber-600 hover:text-amber-700 font-medium transition-colors">
            Sign in
          </a>
        </p>
      </Card>
