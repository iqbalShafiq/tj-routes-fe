  ...
  return (
    <div className="max-w-md mx-auto animate-fade-in">
      <div className="text-center mb-8">
        ...
        <p className="text-slate-600">Sign in to continue to TransJakarta Routes</p>
      </div>
      <Card static>
        <form
          onSubmit={async (e) => {
        ...
        <p className="mt-8 text-center text-sm text-slate-600">
          ...
          <a href="/auth/register" className="text-amber-600 hover:text-amber-700 font-medium transition-colors">
            Register
          </a>
        </p>
      </Card>
