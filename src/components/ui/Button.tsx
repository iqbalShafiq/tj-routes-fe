...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'primary', size = 'md', children, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-accent hover:bg-accent-hover focus:ring-accent disabled:bg-accent/50 text-white dark:!text-slate-900 disabled:text-white/70 dark:disabled:!text-slate-900/70',
      ...
      tertiary: 'bg-tertiary text-white hover:bg-tertiary-hover focus:ring-tertiary disabled:bg-tertiary/50 disabled:text-white/70',
    };
