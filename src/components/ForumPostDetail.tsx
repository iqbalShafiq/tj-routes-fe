          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 flex-wrap mb-1">
                ...
                {postTypeInfo && (
                  <span className="px-2 py-1 text-xs font-medium bg-slate-100 text-slate-700 rounded-full flex items-center gap-1">
                ...
                {post.is_pinned && (
                  <span className="px-2 py-1 text-xs font-medium bg-amber-100 text-amber-700 rounded-full flex items-center gap-1">
                    <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M5 5a2 2 0 012-2h6a2 2 0 012 2v6l-4 4v-6H7a2 2 0 01-2-2V5z" />
                    </svg>
                    <span>Pinned</span>
                  </span>
                )}
          ...
          {(isOwner || isAdmin) && (
            <div className="flex items-center gap-2 flex-shrink-0">
              {isAdmin && (
                <>
                  {post.is_pinned ? (
                    <Button variant="outline" size="sm" onClick={() => onUnpin?.(post.id)}>
                      Unpin
                    </Button>
                  ) : (
                    <Button variant="outline" size="sm" onClick={() => onPin?.(post.id)}>
                      Pin
                    </Button>
                  )}
                </>
